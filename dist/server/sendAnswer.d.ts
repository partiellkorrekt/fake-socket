...
export declare const sendError: (response: express.Response<string>, message: string, error: Error, socket?: FakeSocketConnection | null | undefined, statusCode?: number) => void;
export declare const sendData: (response: express.Response<string>, message: string, data?: {
    [key: string]: unknown;
}, socket?: FakeSocketConnection | undefined, statusCode?: number) => void;
